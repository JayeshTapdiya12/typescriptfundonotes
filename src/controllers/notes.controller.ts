...
class NoteController {
  ...
  public deleteCollaborators = async (
    ...
    try {
      const data = await this.noteService.deleteCollaborators(
        req.body,
        req.params._id
      );
      ...
      res.status(500).json({
        message:
          'An error occurred during deleting the collaborators of  the note  of the user',
        error: error instanceof Error ? error.message : 'Unknown error'
      });
    }
  };
  ...
  public addCollaborators = async (
    ...
    try {
      const data = await this.noteService.addCollaborators(
        req.body,
        req.params._id
      );
      ...
      res.status(500).json({
        message:
          'An error occurred during adding the collaborators of  the note  of the user',
        error: error instanceof Error ? error.message : 'Unknown error'
      });
    }
  };
